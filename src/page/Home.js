    ...
    <div className="container py-32 mx-auto">
      <span>
        <h1 className="text-center text-4xl pb-10 font-bold">
          <span className="text-red-500 uppercase">g</span>
          <span>an</span>
          <span className="text-red-500">teng</span>
          <span className="text-red-500 text-xs">.merah</span>
        </h1>
      </span>
      <div className="flex justify-center">
        <div className="w-80 bg-slate-50 shadow-xl py-3 px-5 flex justify-center rounded-lg">
          <form action="">
            ...
            <Link to={encodeQ} className="py-1 px-2 rounded-lg bg-red-500">
              Search
            </Link>
          </form>
        </div>
      ...
      <div className="text-center pt-20">
        ...
        <p>
          made by <span className="text-red-500 underline">Chairil Ali</span>
        </p>
      </div>
    </div>
  );
